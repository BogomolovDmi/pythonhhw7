...
def group_file_in_dir(dir_source: str, dir_rezult: str):
    ...
    folder_track = Path(Path.cwd() / dir_source)          #C:\Users\Asus\PycharmProjects\pythonProject7\new
    folder_move = Path(Path.cwd() / dir_rezult)           #C:\Users\Asus\PycharmProjects\pythonProject7\rezult
